									...
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0 cellPadding=2 width=155 align=center border=0>
											<TBODY>
												...
												<TR> 
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/customer/customer_findAll.action" target=main>－ 客户列表</A>
													</TD>
												</TR>
											</TBODY>
										</TABLE>
									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/linkMan/linkMan_findAll.action" target=main>－联系人列表</A>
													</TD>
												</TR>
