...
public class Poker {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> iPlayer4 = new ArrayList<Integer>();
        
        ArrayList<Integer> iCards = new ArrayList<Integer>();
        
        //遍历这副洗好的牌,遍历过程中,将牌发到三个玩家的底牌中
