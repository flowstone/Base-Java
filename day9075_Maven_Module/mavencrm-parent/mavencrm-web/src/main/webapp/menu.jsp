									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
													<s:a action="linkMan_showadd" namespace="/" cssClass="style2" target="main">
													－ 新增联系人
													</s:a>	
												...
												<TR>
													<TD class=menuSmall>
													<s:a action="linkMan_listPage" namespace="/" cssClass="style2" target="main">
													－联系人列表
													</s:a>
														</TD>
												</TR>
									...
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
													<s:a action="saleVisit_showadd" namespace="/" cssClass="style2" target="main">
														－新增客户拜访
													</s:a>	
