...
<BODY>
	<s:form action="linkMan_edit" namespace="/" method="post" id="form1" name="form1">
		<!-- id隐藏域 -->
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								<td>爱好 ：</td>
								<td colspan="3">
									<!-- 注意：value必须是数组，可以使用强制解析ognl表达式，来调用实例方法来切割成数组，因为数据库存的是逗号空格分割的的字符串 -->
									<s:checkboxlist list="{'睡觉','打豆豆','大宝剑'}" name="lkm_hobby" value="%{lkm_hobby.split(', ')}"/>		
								</td>
							</TR>
							<tr>
								<td rowspan=2>
