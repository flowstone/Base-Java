...
<BODY>
	<s:form action="linkMan_listPage" namespace="/" method="post" 
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>联系人名称：</TD>
													<TD>
														<s:textfield name="lkm_name" cssStyle="WIDTH: 80px" maxLength="50"  cssClass="textbox" id="sChannel2"/>
													</TD>
													<TD>联系人性别：</TD>
													<TD>
														<s:select list="#{'1':'男','0':'女'}" headerKey="" headerValue="--请选择--"
														name="lkm_gender" ></s:select>
													</TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="#pagination.resultList">
													...
													&nbsp;&nbsp;
													<s:a action="linkMan_delete" namespace="/" cssClass="delLink">
														<s:param name="lkm_id" value="lkm_id"/>
														删除
													</s:a>
